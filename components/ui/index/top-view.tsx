...
export default function TopView() {
  return (
    <section id="top-view" className="bg-yellow-50 text-secondary-foreground">
      <div className="w-full min-h-[600px] bg-yellow-50 relative px-6 py-26 md:py-24 overflow-hidden">
        <div className="max-w-6xl mx-auto relative">
          <div className="flex flex-col gap-6 md:gap-8 z-10 relative">
            <h2 className="text-4xl md:text-6xl font-bold text-neutral-800 leading-tight md:leading-tight max-w-xl">
              眠っているお宝、
              <br />
              驚きの価格で買い取ります
            </h2>
